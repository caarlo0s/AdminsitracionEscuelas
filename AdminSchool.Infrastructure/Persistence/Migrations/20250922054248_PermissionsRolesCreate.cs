...
{
    /// <inheritdoc />
    public partial class PermissionsRolesCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupSchools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupSchools_Grades_GradeId",
                        column: x => x.GradeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_GroupSchools_GroupId",
                        column: x => x.GroupId,
                        principalTable: "GroupSchools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentPayments_PaymentConcepts_PaymentConceptId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentTutors", x => new { x.StudentsId, x.TutorsId });
                    table.ForeignKey(
                        name: "FK_StudentTutors_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPayments_PaymentConceptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTutors_TutorsId",
                table: "StudentTutors",
                column: "TutorsId");
